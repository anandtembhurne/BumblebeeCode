 ...
 * If you can't find the type definition in the registry we can make an ambient/global definition
 * in this file for now. For example
 ...
 * notice how we have to create a namespace that is equal to the function we're assigning the
 * export to
