...
//            org.apache.log4j.Logger  logger=org.apache.log4j.Logger.getLogger(DBSTransactionState.class);
            List<Serializable> aclList = (List<Serializable>) state.get(KEY_ACP);
            
            log.debug("state log ==="+state.get(KEY_ACP));
        	...
        	log.error("State key ="+state.get(KEY_ACP));
