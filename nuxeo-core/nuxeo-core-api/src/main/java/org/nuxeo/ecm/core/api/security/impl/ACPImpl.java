...
public class ACPImpl implements ACP {
	...
	private static final Log log = LogFactory.getLog(ACPImpl.class);
    ...
    public void addACL(ACL acl) {
        ...
        if (!acl.equals(oldACL)) {
            ...
            if (oldACL != null) {
                ...
                log.info("inside else  name ......"+name);
                switch (name) {
...
//    	log.info("insdide get access .................");
    ...
    public ACL getOrCreateACL(String name) {
    	log.info("inside getOrCreateACL ........"+name);
        ACL acl = getACL(name);
        log.info("acl obj ="+acl);
        if (acl == null) {
    ...
    public boolean addACE(String aclName, ACE ace) {
    	log.info("inside add ace ......"+ace.toString());
        ...
        log.info("acl change status ="+aclChanged);
        if (aclChanged) {
            addACL(acl);
        }
        return aclChanged;
