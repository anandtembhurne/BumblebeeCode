...
public class BlockPermissionInheritance {
    ...
    private static final Log log = LogFactory.getLog(BlockPermissionInheritance.class);
    ...
    public DocumentModel run(DocumentModel doc) {
    	log.info("inside run method ... using document  model");
    ...
    public DocumentModel run(DocumentRef docRef) {
    	log.info("inside run method ... using document Ref");
