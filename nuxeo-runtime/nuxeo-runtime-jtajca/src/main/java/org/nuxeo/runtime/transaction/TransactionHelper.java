...
public class TransactionHelper {
    ...
    public static boolean isTransactionTimedOut() {
        TransactionManager tm = NuxeoContainer.getTransactionManager();
//        log.error("transaction manager ="+tm);
        if (tm == null) {
            return false;
        }
        try {
...
//                log.error("time out ="+timeout);
//                log.error("time value ="+timeout.longValue());
//                log.error("time mill sec ="+System.currentTimeMillis());
//                log.error("status info =="+(System.currentTimeMillis() > timeout.longValue()));
                //defalut code
...
//                return false; // new code
    ...
    public static void commitOrRollbackTransaction() {
        UserTransaction ut = NuxeoContainer.getUserTransaction();
        log.info("user transaction manager data="+ut);
        if (ut == null) {
            return;
        }
        try {
